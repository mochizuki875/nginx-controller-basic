...
// +kubebuilder:printcolumn:JSONPath=".status.deploymentName",name=DeploymentName,type=string
// +kubebuilder:printcolumn:JSONPath=".status.availableReplicas",name=AvailableReplicas,type=integer
